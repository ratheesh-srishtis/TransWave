...
import { getAllDesignations, deleteDesignation } from '../../services/apiHrSettings';
...
<div className="">
        <button onClick={()=>{
          OpenDialog();
        }} className="btn btn-info infobtn addleave">Add Designation</button>
      </div>
</div>
      <div>
            <DataGrid
...
<AddDesigination open={open} onClose={handleClose} listDesiginations={handleListDesiginations} editMode={editMode}  desiginations={selectedRow} errors={errors} setErrors={setErrors} ></AddDesigination>
    </div>
   {openPopUp && (
