...
import { getAllWorkCalendars, deleteWorkCalendar } from '../../services/apiHrSettings';
...
<div className="">
        <button onClick={()=>{
          OpenDialog();
        }} className="btn btn-info infobtn addleave">Add Working Days</button>
      </div>
</div>
      <div>
            <DataGrid
...
<AddWorkCalendar open={open} onClose={handleClose} listworkingCalendar={handleListWorkCalendar} editMode={editMode}  workcalendar={selectedRow} errors={errors} setErrors={setErrors} ></AddWorkCalendar>
    </div>
   {openPopUp && (
